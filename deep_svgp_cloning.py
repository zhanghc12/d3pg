...
from tqc.gp_model import IndependentMultitaskGPModel, FeatureExtractor, DKLModel
...
if __name__ == "__main__":
    ...
    # todo 2: multitask
    # todo 3: deep kernel
    # todo 4: spectral normalization things
    ...
    feature_extractor = FeatureExtractor(state_dim, action_dim)
    num_features = 256
