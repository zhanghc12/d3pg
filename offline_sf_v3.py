...
if __name__ == "__main__":
    ...
    if torch.cuda.is_available():
        experiment_dir = '/data/zhanghc/sf_v3/'
    else:
        experiment_dir = '/tmp/data/zhanghc/sf_v3/'
    experiment_dir = experiment_dir + '0110/'
    ...
    policy = td3_v3.TD3(state_dim, action_dim, args.discount, args.tau, args.bc_scale)
