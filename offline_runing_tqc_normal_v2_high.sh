...
CUDA_VISIBLE_DEVICES=3 python offline_tqc.py --policy TQC  --version $1  --top_quantiles_to_drop_per_net $2 --n_nets $3  --env walker2d-medium-expert-v2  --seed 0 &\
CUDA_VISIBLE_DEVICES=0 python offline_tqc.py --policy TQC  --version $1  --top_quantiles_to_drop_per_net $2 --n_nets $3  --env walker2d-expert-v2 --seed 0
