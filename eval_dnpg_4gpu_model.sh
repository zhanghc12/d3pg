...
CUDA_VISIBLE_DEVICES=2 python main_dnpg_v4.py --policy D4PG  --version $1 --ratio $2  --target_threshold 10 --seed 13  --env $3   &\
CUDA_VISIBLE_DEVICES=3 python main_dnpg_v4.py --policy D4PG  --version $1 --ratio $2  --target_threshold 0.01 --seed 14  --env $3
