...
class TD3(object):
    ...
    def get_stat(self, memory, batch_size=256):
        ...
        self.partion_psi_norm = np.array(self.psi_list)[np.argpartition(self.psi_list, 1000)][1000]
    ...
    def train_policy(self, memory, batch_size):
        ...
        if self.total_it % 2 == 0:
            ...
            # Compute actor losse
            actor_loss = -self.critic.Q1(state_batch, self.policy(state_batch)).mean() -self.critic.Q1(state_batch, self.policy(state_batch)).mean()
