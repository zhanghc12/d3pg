...
CUDA_VISIBLE_DEVICES=4 python offline_kd_final.py --policy TQC  --version $1  --bc_scale $2  --env hopper-expert-v2 --seed $3 &\
CUDA_VISIBLE_DEVICES=5 python offline_kd_final.py --policy TQC  --version $1  --bc_scale $2 --env halfcheetah-random-v2 --seed $3 &\
CUDA_VISIBLE_DEVICES=6 python offline_kd_final.py --policy TQC  --version $1  --bc_scale $2  --env halfcheetah-medium-v2  --seed $3 &\
CUDA_VISIBLE_DEVICES=7 python offline_kd_final.py --policy TQC  --version $1  --bc_scale $2  --env halfcheetah-medium-expert-v2  --seed $3 &\
...
CUDA_VISIBLE_DEVICES=4 python offline_kd_final.py --policy TQC  --version $1  --bc_scale $2  --env walker2d-medium-expert-v2  --seed $3 &\
CUDA_VISIBLE_DEVICES=5 python offline_kd_final.py --policy TQC  --version $1  --bc_scale $2  --env walker2d-medium-replay-v2 --seed $3 &\
CUDA_VISIBLE_DEVICES=6 python offline_kd_final.py --policy TQC  --version $1  --bc_scale $2  --env walker2d-expert-v2 --seed $3
