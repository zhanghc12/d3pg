...
CUDA_VISIBLE_DEVICES=2 python main_dnpg_v3.py --policy D4PG  --version $1 --ratio $2  --target_threshold 0.1 --seed $3  --env Hopper-v2   &\
CUDA_VISIBLE_DEVICES=3 python main_dnpg_v3.py --policy D4PG  --version $1 --ratio $2  --target_threshold 0.1 --seed $4  --env Hopper-v2 &\
...
CUDA_VISIBLE_DEVICES=2 python main_dnpg_v3.py --policy D4PG  --version $1 --ratio $2  --target_threshold 0.1 --seed $3  --env Ant-v2   &\
CUDA_VISIBLE_DEVICES=3 python main_dnpg_v3.py --policy D4PG  --version $1 --ratio $2  --target_threshold 0.1 --seed $4  --env Ant-v2
