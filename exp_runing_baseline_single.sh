...
CUDA_VISIBLE_DEVICES=0 python main_exp.py --policy Dueling  --version $1 --exp_version $2  --env HalfCheetah-v2 --seed 0 &\
CUDA_VISIBLE_DEVICES=1 python main_exp.py --policy Dueling  --version $1 --exp_version $2  --env Ant-v2 --seed 0 &\
...
CUDA_VISIBLE_DEVICES=0 python main_exp.py --policy Dueling   --version $1 --exp_version $2  --env HalfCheetah-v2 --seed 1 &\
CUDA_VISIBLE_DEVICES=1 python main_exp.py --policy Dueling  --version $1 --exp_version $2  --env Ant-v2 --seed 1 &\
...
CUDA_VISIBLE_DEVICES=0 python main_exp.py --policy Dueling   --version $1  --exp_version $2 --env HalfCheetah-v2 --seed 2 &\
CUDA_VISIBLE_DEVICES=1 python main_exp.py --policy Dueling   --version $1  --exp_version $2 --env Ant-v2 --seed 2 &\
...
CUDA_VISIBLE_DEVICES=0 python main_exp.py --policy Dueling  --version $1  --exp_version $2 --env HalfCheetah-v2 --seed 3 &\
CUDA_VISIBLE_DEVICES=1 python main_exp.py --policy Dueling   --version $1  --exp_version $2 --env Ant-v2 --seed 3
