...
CUDA_VISIBLE_DEVICES=4 python offline_kd_td3bc.py --policy TQC  --version 1  --bc_scale 200  --env hopper-expert-v2 --seed $1 --output_dim 9 &\
CUDA_VISIBLE_DEVICES=5 python offline_kd_td3bc.py --policy TQC  --version 3  --bc_scale 200 --env halfcheetah-random-v2 --seed $1 --output_dim 6 &\
CUDA_VISIBLE_DEVICES=6 python offline_kd_td3bc.py --policy TQC  --version 3  --bc_scale 200  --env halfcheetah-medium-v2  --seed $1 --output_dim 6 &\
CUDA_VISIBLE_DEVICES=7 python offline_kd_td3bc.py --policy TQC  --version 1  --bc_scale 20  --env halfcheetah-medium-expert-v2  --seed $1 --output_dim 9 &\
...
CUDA_VISIBLE_DEVICES=4 python offline_kd_td3bc.py --policy TQC  --version 1  --bc_scale 3.25  --env walker2d-medium-expert-v2  --seed $1 --output_dim 9 &\
CUDA_VISIBLE_DEVICES=5 python offline_kd_td3bc.py --policy TQC  --version 3  --bc_scale 200  --env walker2d-medium-replay-v2 --seed $1 --output_dim 9 &\
CUDA_VISIBLE_DEVICES=6 python offline_kd_td3bc.py --policy TQC  --version 1  --bc_scale 3.25  --env walker2d-expert-v2 --seed $1 --output_dim 9
