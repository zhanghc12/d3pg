...
class FeatureExtractor(nn.Module):
    def __init__(self, state_dim, action_dim, hidden_dim=256, feat_dim=3):
        ...
        self.feature_l2 = spectral_norm(nn.Linear(hidden_dim, hidden_dim), norm_bound=norm_bound, n_power_iterations=1)
...
if __name__ == "__main__":
    ...
    for env_name in envs_list:
        ...
        feature_nn = FeatureExtractor(state_dim, action_dim, 256, 3).to(device)
        ...
        while i + batch_size < replay_buffer.size:
            ...
            phi = feature_nn(state_batch, action_batch)
        ...
        iid_list = knn_utils.test_tree_true_sn(replay_buffer, tree, feature_nn, k=5)
