...
CUDA_VISIBLE_DEVICES=4 python main_mbpo.py --version 12 --seed 14 --env_name HalfCheetah-v2 &\
CUDA_VISIBLE_DEVICES=5 python main_mbpo.py --version 12 --seed 15 --env_name HalfCheetah-v2 &\
CUDA_VISIBLE_DEVICES=6 python main_mbpo.py --version 12 --seed 16 --env_name HalfCheetah-v2 &\
CUDA_VISIBLE_DEVICES=7 python main_mbpo.py --version 12 --seed 17 --env_name HalfCheetah-v2
