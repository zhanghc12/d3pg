...
import argparse
import os
from knn_ue import td3_v6, knn_utils
...
if __name__ == "__main__":
    ...
    experiment_dir = experiment_dir + '0111/'
    ...
    policy = td3_v6.TD3(state_dim, action_dim, args.discount, args.tau, args.bc_scale, args.n_nets, args.n_quantiles)
    ...
    for t in range(int(args.max_timesteps)):
        if args.version == 3:
            ...
            critic_loss, actor_loss = policy.train_policy_baseline(replay_buffer, args.batch_size, trees)
        else:
