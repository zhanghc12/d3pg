...
CUDA_VISIBLE_DEVICES=1 python offline_kd.py --env hopper-expert-v2  --bc_sacle 0.1 --seed 1 --loading 1 --k 10 &\
CUDA_VISIBLE_DEVICES=2 python offline_kd.py --env hopper-expert-v2  --bc_sacle 10 --seed 0 --loading 1 --k 10 &\
CUDA_VISIBLE_DEVICES=3 python offline_kd.py --env hopper-expert-v2  --bc_sacle 100 --seed 1 --loading 1 --k 10
