...
CUDA_VISIBLE_DEVICES=2 python offline_kd.py --env hopper-expert-v2  --bc_scale 1 --seed 0 --loading 1 --k 10 &\
CUDA_VISIBLE_DEVICES=3 python offline_kd.py --env hopper-expert-v2  --bc_scale 10 --seed 1 --loading 1 --k 10
