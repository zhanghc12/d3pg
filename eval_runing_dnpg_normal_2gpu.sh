CUDA_VISIBLE_DEVICES=0 python main_dnpg.py --policy D4PG  --version 5  --target_threshold 1  --env $1 --test 1 &\
CUDA_VISIBLE_DEVICES=1 python main_dnpg.py --policy D4PG  --version 5  --target_threshold 10  --env $1 --test 1
