...
CUDA_VISIBLE_DEVICES=2 python main_mbpo.py --version 12 --seed 12 --model_type tensorflow --env_name Walker2d-v2 &\
CUDA_VISIBLE_DEVICES=3 python main_mbpo.py --version 12 --seed 13 --model_type tensorflow --env_name Walker2d-v2
