...
CUDA_VISIBLE_DEVICES=0 python main_exp.py --policy Dueling --version $1  --exp_version $2 --env HalfCheetah-v2 --seed 4 &\
CUDA_VISIBLE_DEVICES=1 python main_exp.py --policy Dueling   --version $1  --exp_version $2 --env Ant-v2 --seed 4 &\
...
CUDA_VISIBLE_DEVICES=0 python main_exp.py --policy Dueling  --version $1   --exp_version $2 --env HalfCheetah-v2 --seed 5 &\
CUDA_VISIBLE_DEVICES=1 python main_exp.py --policy Dueling   --version $1  --exp_version $2  --env Ant-v2 --seed 5 &\
...
CUDA_VISIBLE_DEVICES=0 python main_exp.py --policy Dueling   --version $1  --exp_version $2  --env HalfCheetah-v2 --seed 6 &\
CUDA_VISIBLE_DEVICES=1 python main_exp.py --policy Dueling  --version $1  --exp_version $2  --env Ant-v2 --seed 6 &\
...
CUDA_VISIBLE_DEVICES=0 python main_exp.py --policy Dueling  --version $1   --exp_version $2 --env HalfCheetah-v2 --seed 7 &\
CUDA_VISIBLE_DEVICES=1 python main_exp.py --policy Dueling   --version $1 --exp_version $2  --env Ant-v2 --seed 7