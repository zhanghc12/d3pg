...
if __name__ == "__main__":
    ...
    parser.add_argument("--bc_scale", type=float, default=0.01)
    ...
    policy = dppg_v4.TD3(state_dim, action_dim, args.discount, args.tau, args.bc_scale, args.version)
