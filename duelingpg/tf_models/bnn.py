...
from duelingpg.tf_models.utils import get_required_argument, TensorStandardScaler
from duelingpg.tf_models.fc import FC

from duelingpg.tf_models.tf_logging import Progress, Silent
...
class BNN:
    ...
    def __init__(self, params):
        ...
        # self._model_inds = np.arange(params['num_elites']).tolist()
    ...
    def train(self, inputs, labels,
        ...
        targets, holdout_targets = labels[permutation[num_holdout:]], labels[permutation[:num_holdout]]
    ...
    def predict(self, inputs, factored=True, *args, **kwargs):
    ...
    def step(self, obs, act, deterministic=False):
        ...
        model_inds = self.random_inds(batch_size)
