...
class DVPG(object):
    ...
    def train(self, replay_buffer, onpolicy_buffer, batch_size=256):
        self.total_it += 1
        ...
        # on policy part, the most recent 1000 samples
        ...
        # current_value, _, _ = self.critic(state, self.actor(state))
