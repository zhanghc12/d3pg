CUDA_VISIBLE_DEVICES=0 python main_mbpo.py --version 0 --seed 0 --env_name Walker2d-v2 &\
CUDA_VISIBLE_DEVICES=0 python main_mbpo.py --version 1 --seed 0 --env_name Walker2d-v2 &\
CUDA_VISIBLE_DEVICES=0 python main_mbpo.py --version 2 --seed 0 --env_name Walker2d-v2 &\
...
CUDA_VISIBLE_DEVICES=2 python main_mbpo.py --version 1 --seed 0 --env_name Hopper-v2 &\
CUDA_VISIBLE_DEVICES=2 python main_mbpo.py --version 2 --seed 0 --env_name Hopper-v2 &\
CUDA_VISIBLE_DEVICES=3 python main_mbpo.py --version 0 --seed 1 --env_name Hopper-v2 &\
CUDA_VISIBLE_DEVICES=3 python main_mbpo.py --version 1 --seed 1 --env_name Hopper-v2 &\
CUDA_VISIBLE_DEVICES=3 python main_mbpo.py --version 2 --seed 1 --env_name Hopper-v2
