...
if __name__ == "__main__":
    ...
    for t in range(int(args.max_timesteps)):
        ...
        if t >= args.start_timesteps:
            actor_loss, critic_loss, q1, q2, q_diff, bias_loss, bias_diff,  q_diff1, q_diff2, q_diff3, q_diff4, q_diff5,  q_diff6, q_diff7, q_diff8, q_diff9, q_diff10= policy.train(replay_buffer, args.batch_size)
            ...
            writer.add_scalar('value/q_diff7', q_diff7, t)
            writer.add_scalar('value/q_diff8', q_diff8, t)
            writer.add_scalar('value/q_diff9', q_diff9, t)
            writer.add_scalar('value/q_diff10', q_diff10, t)
