...
CUDA_VISIBLE_DEVICES=0 python main_mbpo_replicate.py --version 12 --seed 11 --env_name Walker2d-v2 &\
CUDA_VISIBLE_DEVICES=1 python main_mbpo_replicate.py --version 12 --seed 10 --model_type tensorflow --env_name Walker2d-v2 &\
CUDA_VISIBLE_DEVICES=2 python main_mbpo_replicate.py --version 12 --seed 11 --model_type tensorflow --env_name Walker2d-v2
